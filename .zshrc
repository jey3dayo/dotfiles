...
export PATH=/opt/local/bin:/opt/local/sbin:/bin:/usr/bin:/usr/local/bin:/Developer/SDKs/flex_sdk/bin:$PATH
...
alias growlcall="growlnotify -t "Terminal" -m 'Finishing the Task.'"

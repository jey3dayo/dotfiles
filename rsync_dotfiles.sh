...
rsync --progress -avp /opt/local/apache2/conf/httpd.conf ~/Documents/dotfiles/conf/
rsync --progress -avp /opt/local/etc/mysql5/my.cnf       ~/Documents/dotfiles/conf/
rsync --progress -avp /opt/local/etc/php5/php.ini        ~/Documents/dotfiles/conf/

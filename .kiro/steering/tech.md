...
- Managed Assets: edit `~/.apm/catalog/`, and keep external skill mapping in `~/.apm/apm.yml`
- Daily Operation: `cd ~/.apm && mise run deploy`, `mise run doctor`, and `mise run validate:catalog`

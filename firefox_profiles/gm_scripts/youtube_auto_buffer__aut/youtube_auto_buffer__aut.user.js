...
//prompt("fmt map", fmt_map.replace(/,/g, "     "));
//prompt("vq", fv.getPref("vq"));

if(fmt_map.find("5/0/7/0/0")) hd["360p"] = true;
if(fmt_map.find("35/640000/9/0/115") || fmt_map.find("34/0/9/0/115") || fmt_map.find("18/512000/9/0/115")) hd["480p"] = true;
if(fmt_map.find("22/2000000/9/0/115")) hd["720p"] = true;
if(fmt_map.find("37/4000000/9/0/115")) hd["1080p"] = true;
switch(opHD) { // find the right/best quality according to the options
	case "360p": if(hd["360p"] === true) fv = fv.setVar("vq", "medium"); break;
	case "480p": if(hd["480p"] === true) fv = fv.setVar("vq", "large");
					else fv = fv.setVar("vq", "360p"); break;
	case "720p": if(hd["720p"] === true) fv = fv.setVar("vq", "hd720");
					else if(hd["480p"] === true) fv = fv.setVar("vq", "large");
					else if(hd["360p"] === true) fv = fv.setVar("vq", ""); break;
	case "1080p": if(hd["1080p"] === true) fv = fv.setVar("vq", "hd1080");
					else if(hd["720p"] === true) fv = fv.setVar("vq", "hd720");
					else if(hd["480p"] === true) fv = fv.setVar("vq", "large");
					else if(hd["360p"] === true) fv = fv.setVar("vq", ""); break;
}

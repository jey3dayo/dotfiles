...
Sources: docs/documentation-guidelines.md, docs/README.md.
...
- Documentation governance remains in docs/documentation-guidelines.md; update the mapping table there when adding or splitting docs.
...
## Update workflow
- On any doc change, refresh `最終更新`, validate tags, and append to the mapping table in docs/documentation-guidelines.md.

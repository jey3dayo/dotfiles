...
- On macOS/Linux/WSL2, treat mise bootstrap (`mise bootstrap` / `mise dotfiles apply`) as the deployment path. Home Manager is legacy; remaining WSL2 cutover work is tracked in `todo.txt`.

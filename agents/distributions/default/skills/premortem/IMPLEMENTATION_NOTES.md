...
**決定**: Serena統合をオプション機能として実装
**フォールバック**: Serena未使用時はripgrepで代替
**理由**:
...
**決定**: README.md、CLAUDE.md、.kiro/steering/\*.md のみを解析
**理由**:

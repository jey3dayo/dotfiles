...
**統合理由**: TaskContext標準化とCommunication Busパターンを提供

**統合タイミング**: フレームワーク理解のために自動ロード
...
**統合理由**: エージェント選択ロジックと能力マッチング

**統合タイミング**: エージェントルーティング判断時に自動参照
...
**統合理由**: Context7やその他MCPサーバー統合の設定ガイダンス

**統合タイミング**: MCPサーバーエラーやセットアップが必要な場合

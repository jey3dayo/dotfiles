...
export async function loadTsrConfig(projectRoot: string): Promise<ResolvedConfig> {
  ...
  const configSource: "project" | "home" | "default" = projectConfig ? "project" : homeConfig ? "home" : "default";
 ...
 */
export async function saveProjectConfig(projectRoot: string, config: Partial<TsrConfig>): Promise<void> {

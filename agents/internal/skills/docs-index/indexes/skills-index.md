...
| `pr-feedback-orchestrator` | GitHub PR feedback orchestrator — ingests CI failures, review comments, and bot feedback, then coordinates fixes and verification. Orchestrates gh-fix-ci and gh-address-comments. Use when CI fails, PR has review comments, or need automated PR feedback fixes. |
